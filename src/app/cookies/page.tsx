...
export const metadata = { title: 'Cookie Policy — Temu Deals', description: 'How Temu Deals uses cookies on our website.' };
    ...
    <>
      ...
      <main className="pt-24 pb-20 px-6 lg:px-10 max-w-3xl mx-auto">
        ...
        <div className="space-y-5 text-[15px] leading-relaxed text-on-surface-variant">
          <p>This Cookie Policy explains how Temu Deals uses cookies and similar technologies when you visit our website.</p>
