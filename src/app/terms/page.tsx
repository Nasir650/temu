...
export const metadata = { title: 'Terms of Service — Spy Web Cams', description: 'Terms and conditions for using Spy Web Cams.' };
    ...
    <>
      ...
      <main className="pt-24 pb-20 px-6 lg:px-10 max-w-3xl mx-auto">
        ...
        <div className="space-y-5 text-[15px] leading-relaxed text-on-surface-variant">
          ...
          <p>By accessing and using Spy Web Cams, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, please do not use our website.</p>
          <h2 className="text-2xl font-headline font-bold text-forest-900 mt-8">Nature of Our Service</h2>
          <p>Spy Web Cams is an affiliate marketing website. We curate and showcase deals from the Temu marketplace. We do not sell products directly. When you click on a product link, you will be redirected to Temu&apos;s website where you can complete your purchase.</p>
          ...
          <p>Spy Web Cams is provided &ldquo;as is&rdquo; without warranties of any kind. We are not liable for any damages arising from your use of this website or purchases made through our affiliate links. All transactions are between you and the merchant.</p>
