...
export const metadata = { title: 'About Us — Spy Web Cams', description: 'Learn about Spy Web Cams, your trusted source for curated Temu affiliate deals and products.' };
    ...
    <>
      ...
      <main className="pt-24 pb-20 px-6 lg:px-10 max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-on-surface-variant space-y-5 text-[15px] leading-relaxed">
          <p>Welcome to <strong className="text-forest-900">Spy Web Cams</strong> — your trusted destination for curated deals from the Temu marketplace.</p>
