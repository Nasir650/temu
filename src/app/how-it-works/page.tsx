...
export const metadata = { title: 'How It Works — Temu Deals', description: 'Learn how Temu Deals works and start saving today.' };
  ...
  return (
    <>
      ...
      <main className="pt-24 pb-20 px-6 lg:px-10 max-w-3xl mx-auto">
        ...
        <p className="text-on-surface-variant mb-12">Getting the best Temu deals is as easy as 1-2-3-4.</p>
